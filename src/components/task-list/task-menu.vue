<template>
  <section class="task-menu-container">
    ...
    <div class="menu-item" @click="select">
      <span>Select item</span>
    </div> -->
    <div class="menu-item" @click="duplicate">
      <svg viewBox="0 0 20 20" fill="currentColor" width="16" height="16" aria-hidden="true" aria-label="Duplicate Board" class="icon_component icon_component--no-focus-style">
        <path
    ...
    <div class="menu-item" @click="remove">
      <font-awesome-icon icon="trash-alt" />
      <span>Delete</span>
    </div>
    <!-- <div class="menu-item" @mousemove="toggleMoveToOptions">
